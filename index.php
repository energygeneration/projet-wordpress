                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12 col-lg-7">
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="ban_track">
                                       <figure><img src="<?php echo get_template_directory_uri().'/assets/images/track.png';?>" alt="#"/></figure>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <form class="transfot">
            ...
            <div class="row d_flex">
               <div class="col-md-6">
                  <div class="about_right">
                     <figure><img src="<?php echo get_template_directory_uri().'/assets/images/about.png';?>" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="titlepage">
               ...
               <div class="col-md-12">
                  <div class="service_main">
                     <div class="service_box blu_colo">
                        <i><img src="<?php echo get_template_directory_uri().'/assets/images/ser1.png';?>" alt="#"/></i>
                        <h4>FLY ANYWHERE</h4>
                     </div>
                     <div class="service_box yelldark_colo">
                        <i><img src="<?php echo get_template_directory_uri().'/assets/images/ser2.png';?>" alt="#"/></i>
                        <h4>Cargo service</h4>
                     </div>
                     <div class="service_box yell_colo">
                        <i><img src="<?php echo get_template_directory_uri().'/assets/images/ser3.png';?>" alt="#"/></i>
                        <h4> COURIER SERVICES</h4>
                     </div>
                     <div class="service_box yelldark_colo">
                        <i><img src="<?php echo get_template_directory_uri().'/assets/images/ser4.png';?>" alt="#"/></i>
                        <h4>BOX STORAGE</h4>
                     </div>
                     <div class="service_box yell_colo">
                        <i><img src="<?php echo get_template_directory_uri().'/assets/images/ser5.png';?>" alt="#"/></i>
                        <h4>100% safe</h4>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="vehicles_truck">
                                 <figure><img src="<?php echo get_template_directory_uri().'/assets/images/truc1.png';?>" alt="#"/></figure>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="vehicles_truck">
                                 <figure><img src="<?php echo get_template_directory_uri().'/assets/images/truc2.png';?>" alt="#"/></figure>
                              </div>
                              <h3 class="blac_co">Truck</h3>
                           </div>
                           <div class="col-md-4">
                              <div class="vehicles_truck">
                                 <figure><img src="<?php echo get_template_directory_uri().'/assets/images/truc3.png';?>" alt="#"/></figure>
                              </div>
                           </div>
                        </div>
                     </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="testimonial_box">
                                          <figure><img src="<?php echo get_template_directory_uri().'/assets/images/our.png';?>" alt="#"/></figure>
            ...
            <div class="row">
               <div class="col-md-5">
                  <div class="choose_box">
                     <i><img src="<?php echo get_template_directory_uri().'/assets/images/why1.png';?>" alt="#"/></i>
                     <h3>Our Vission</h3>
               ...
               <div class="col-md-5 offset-md-2">
                  <div class="choose_box">
                     <i><img src="<?php echo get_template_directory_uri().'/assets/images/why2.png';?>" alt="#"/></i>
         ...
         <div class="con_bg">
            <div class="container-fluid">
               <div class="row">
                  ...
                  <div class="col-md-7">
                     <div class="co_tru">
                        <figure><img src="<?php echo get_template_directory_uri().'/assets/images/truc4.png';?>" alt="#"/></figure>
                     </div>
                  </div>
               </div>
            </div>
